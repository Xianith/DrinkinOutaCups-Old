...
$lng_change = "&Auml;ndern";
$lng_delete = "L&ouml;schen";
$lng_add = "Hinzuf&uuml;gen";
$lng_deleteMessage = "Wirklich l&ouml;schen?";
$lng_buttonSave = "Speichern";
$lng_buttonChancel = "Abbrechen";
$lng_modeEdit = "Editieren";
$lng_modeOverview = "&Uuml;bersicht";
$lng_modeNew = $lng_add;
$lng_warning = "Achtung";
$lng_warning_ascii = "Nur ASCII Zeichen verwenden!";
$lng_biki_hint = "F&uuml;r weitere Information siehe:";
